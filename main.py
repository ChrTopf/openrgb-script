...
def signal_handler(sig, frame):
    print('This routine was interrupted by a system signal!')
    sys.exit(0)
...
print(f"The motherboard {motherboard.name} was initialized with the primary color.")

mouse = client.get_devices_by_type(DeviceType.MOUSE)[0]
print(f"The following mouse is going to be controlled: {mouse.name}")
